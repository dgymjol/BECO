...
if __name__ == '__main__':
    ...
    # Output Path
    parser.add_argument("--log_name", default="./test/sample_train_eval", type=str)
    parser.add_argument("--cam_weights_name", default="./test/sess/res50_cam.pth", type=str)
    parser.add_argument("--irn_weights_name", default="./test/sess/res50_irn.pth", type=str)
    parser.add_argument("--cam_out_dir", default="./test/result/cam", type=str)
    parser.add_argument("--ir_label_out_dir", default="./test/result/ir_label", type=str)
    parser.add_argument("--sem_seg_out_dir", default="./test/result/sem_seg", type=str)
    parser.add_argument("--ins_seg_out_dir", default="./test/result/ins_seg", type=str)
    parser.add_argument("--score_dir", default="./test/result/score", type=str)
    ...
    os.makedirs("./test/sess", exist_ok=True)
